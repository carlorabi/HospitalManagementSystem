...
<image class="profile-img" src="uploadImage/Logo/<?php echo $logo; ?>" style="width: 48%"></image>
</div>
</a>
...
<li>
<div class="media">
<img class="d-flex align-self-center img-radius" src="files/assets/images/bsulogo.png" alt="Generic placeholder image">
<div class="media-body">
<h5 class="notification-user">Batangas State University</h5>
