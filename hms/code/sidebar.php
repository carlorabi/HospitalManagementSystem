...
<li class="pcoded-hasmenu">
    <a href="javascript:void(0)">
        ...
        <span class="pcoded-mtext">Add Appointment</span>
    </a>
...
<li class="pcoded-hasmenu">
    <a href="javascript:void(0)">
        <span class="pcoded-micon"><i class="feather icon-user"></i></span>
        <span class="pcoded-mtext">Visiting Hour</span>
    </a>
    <ul class="pcoded-submenu">
   
        <li class="">
            <a href="visiting-hour.php">
                <span class="pcoded-mtext">Add Visiting Hour</span>
            </a>
        </li>
    ...
    <?php } ?>
        <li class="">
            <a href="view-patient.php">
                <span class="pcoded-mtext">Patients Records</span>
            </a>
        </li>
    </ul>
</li>
